        ...
        <div className='container'>
            <div className='row p-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    ...
                    <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Charges at TradeSwift</a><br />
                    <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>TradeSwift IDFC FIRST bank 3-in-1 Account</a><br />
                    <a href="" style={{textDecoration: "none", lineHeight: "2.5"}}>Getting Started</a><br />
                </div>

                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-user" aria-hidden="true"></i>Your TradeSwift Account</h4>
